...
export const productSchemaValidation = z.object({
    ...
    category: z.string().trim().min(1, "category Should have minimum one character").array().nonempty(),
    ...
    costPrice: z.number().min(1, "Cost price must have one number"),
    markedPrice: z.number().min(1, "Marked price must have one number"),
